...
**The carried-work list is closed as of 2026-09-04.** Every W row is done, done on a named
branch, or a decision with an owner and a trigger — including W12, whose open question now
carries both rather than sitting in the list unattributed. Nothing above waits on a brief that
does not exist. What remains is the eight pending items, which name Dave, and the two standing
