# open-decisions — closed and archived 2026-09-07

Everything here is **finished**. It was split out of `design/open-decisions.md` because that
file had reached 133 KB of which about 5 KB was live, and two done items had sat in it unnoticed
for three days. Kept rather than deleted: six of the nine D-questions rested on a premise that
did not survive measurement, and the answers record the correction — that is the part worth
reading if you are about to ask the same question again.

Nothing in this file is machine-read. Line references to `open-decisions.md` in the archived
briefs point at the pre-split file and will not resolve; use git history for those.
...
## Carried work — the closed rows

| Item | Question | Origin | State |
|---|---|---|---|
...
## Pending actions — the cleared ones
...
**All six Phase-B briefs landed and are in `.claude/briefs/archive/`** — D1+D9 as
`2026-09-04-fleet-guard-suite-connector-deny.md`, D8 as `2026-09-02-deploy-drift-check.md`,
W5/D6 as `2026-09-02-workflow-coverage-checker.md`, D3 as
`2026-09-02-skills-heading-extraction.md`, D7 as `2026-09-02-hermes-kanban-retirement.md`,
and W1-W4 + D5 as `2026-09-04-carried-work-w1-w4-and-d5-cleanup.md`. The order above is
history, not a plan.
